...
### NOTE in by default in moments (as in dadi), first split produces P2 from P1. Second produced P3 from P2
...
make_3pop_sim_command <- function(params){
    paste("python", "~/Research/genomics_general/sim/sim_SFS_moments.py",
...
#below is code for sunning a single simulation and plotting the result directly

##################################################################################
#########################  standard 3 pop model  #################################
##################################################################################

# NOTE mements, ad in in dadi, first split produces pop 2 from 1. Second produces 3 from 2
...
params <- list(n1 = 10, n2=10, n3=10, #number of samples in each pop
               ...
               p32_m31 = 0, #second three pop period m31
               p32_m13 = 0, #second three pop period m13
               p32_m23 = 2, #second three pop period m31
               p32_m32 = 2 #second three pop period m13
               )
